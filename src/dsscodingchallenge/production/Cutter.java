...
public class Cutter extends Machine {
    ...
    public static int cutterCounter = 0;
    protected static List<Schedule> cutterSchedule = new ArrayList<>();
    
    //</editor-fold>
    
    //<editor-fold defaultstate="expanded" desc="CONSTRUCTOR">

    public Cutter(String machineName) {
        super.setMachineName(machineName);
        Cutter.cutterCounter++;
    }
    ...
    public LocalDateTime cut(LocalDateTime startOfWork, double quantity, String orderId, String productType) {
        Schedule schedule;
        ...
        quantity = super.start(quantity, Cutter.cutterCounter);
        schedule = super.work(startOfWork, quantity, orderId, productType);
        Cutter.cutterSchedule.add(schedule);
        ...
        if (super.remnant > 0) {
            ...
            Cutter.cutterSchedule.add(schedule2);
